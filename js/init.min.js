...
var evento = function (n) {
    ...
    player, OKEvents, options, videoWidth, videoHeight, YTplayers, youtubePlayers = new Array;
OKEvents = {
        yt: {
    ...
    function (window, undefined) {
        ...
        var bodyTop, scrollbarWidth = !1,
            ...
            boxWidth = 0,
            boxLeft = 0,
            parallaxRows, parallaxCols, parallaxHeaders, kenburnsHeaders, kenburnsRows, kenburnsCols, backwashHeaders, backwashRows, backwashCols, visibleRows, headerWithOpacity, speedDivider = SiteParameters.parallax_factor,
            adminBar, pageHeader, headerVideo, masthead, mastheadMobile, mastheadMobilePaddingTop = 0,
            ...
            isMobile = classie.hasClass(document.documentElement, "touch") ? !0 : !1,
            isIE = classie.hasClass(document.documentElement, "ie") || classie.hasClass(document.documentElement, "opera12") ? !0 : !1,
            isFF = classie.hasClass(document.documentElement, "firefox") ? !0 : !1,
            isFullPage, isFullPageSnap, isFrontEndEditor, transitionEvent = whichTransitionEvent(),
            ...
            resizeTimer_, resizeTimer, hidingTimer, isSplitMenu = !1,
            mainNavMenu, mainNavWrapper, isMobileTransparent = !1,
            ...
            calculateMenuHeight = function (first) {
                ...
                if (wwidth > mediaQuery) {
                    ...
                    if (isMobileTransparent)
                        for (var i = 0; i < mainmenu.length; i++) classie.hasClass(mainmenu[i].parentNode, "menu-transparent") && (transmenuHeight += menuHeight);
                    var search_box = document.querySelectorAll(".search-icon .drop-menu");
                    for (var i = 0; i < search_box.length; i++) search_box[i].removeAttribute("style")
                }
                classie.hasClass(document.documentElement, "admin-mode") && (adminBar = document.getElementById("wpadminbar"), wwidth > 600 ? adminBar != null ? adminBarHeight = outerHeight(adminBar) : wwidth > 782 ? adminBarHeight = 32 : adminBarHeight = 46 : adminBarHeight = 0), UNCODE.adminBarHeight = adminBarHeight, UNCODE.menuHeight = menuHeight, UNCODE.isFullPage && !UNCODE.isFrontEndEditor ? (UNCODE.adminBarHeight > 0 && (document.body.style.marginTop = (UNCODE.adminBarHeight + UNCODE.bodyBorder) * -1 + "px"), document.body.style.paddingTop = UNCODE.adminBarHeight + UNCODE.bodyBorder + "px") : (document.body.style.marginTop = 0, document.body.style.paddingTop = 0), masthead != undefined && classie.hasClass(masthead, "menu-transparent") && wwidth > mediaQuery && (masthead.parentNode.style.height = "0px");
            ...
            initHeader = function () {
                ...
                if (pageHeader != undefined) {
                    var backs = pageHeader.querySelectorAll(".header-bg"),
                        ...
                        uri_pattern = /\b((?:[a-z][\w-]+:(?:\/{1,3}|[a-z0-9%])|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]+|\(([^\s()<>]+|(\([^\s()<>]+\)))*\))+(?:\(([^\s()<>]+|(\([^\s()<>]+\)))*\)|[^\s`!()\[\]{};:'".,<>?Â«Â»â€œâ€â€˜â€™]))/ig;
                ...
                if (masthead != undefined && !classie.hasClass(masthead, "masthead-vertical"))
                    if (header.length) {
                        ...
                        for (var j = 0; j < header.length; j++) {
                            ...
                            closestStyle != null && classie.hasClass(closestStyle, "style-light") ? switchColorsMenu(0, "light") : getClosest(headerel, "style-dark") != null ? switchColorsMenu(0, "dark") : masthead.style.opacity !== 1 && (masthead.style.opacity = 1);
                            if (classie.hasClass(masthead, "menu-transparent"))
                                if (isMobileTransparent || wwidth > mediaQuery) {
                                    ...
                                    if (classie.hasClass(masthead, "menu-add-padding")) {
                                        ...
                                        } else getDivChildren(headerel, ".header-content", function (headerContent, i) {
                ...
                if (typeof transmenuel == "undefined" || !transmenuel.length) isMobileTransparent = !1;
                bodyTop = document.documentElement.scrollTop || document.body.scrollTop, UNCODE.bodyTop = bodyTop, classie.hasClass(document.body, "vmenu") || initBox(), scrollFunction(), showHideScrollup(bodyTop);
                if (UNCODE.isMobile) {
            ...
            initRow = function (currentRow) {
                function word_for_lines(event, $parent_el) {
                    ...
                    for (var head_k = 0; head_k < $headings.length; head_k++) {
                        ...
                        if ($owl_carousel !== null)
                            if ($owl_item === null || $owl_item !== null && classie.hasClass($owl_item, "active") && $owl_item.getAttribute("data-index") !== "1" || $owl_item !== null && classie.hasClass($owl_item, "active") && $owl_item.getAttribute("data-index") === "1" && $owl_item.getAttribute("data-already-reached") === "true") continue;
                ...
                getDivChildren(el.parentNode, ".column_parent, .column_child", function (obj, i, total) {
                    obj.className.indexOf("col-md-") > -1 && classie.addClass(obj.parentNode, "cols-md-responsive"), obj.className = obj.className.replace(/vc_col-sm-(\d{1,2})/g, ""), obj.className.indexOf("col-sm-") > -1 && obj.className.indexOf("col-sm-clear") == -1 && classie.addClass(obj.parentNode, "cols-sm-responsive")
                }), setRowHeight(el);
                var elements = 0;
                ...
                var wrapLinesWw = wwidth,
                    setWrap, $h_markup = document.body.querySelectorAll(".font-obs"),
                    fontArr = new Array;
            ...
            setRowHeight = function (container, forced, resized) {
                ...
                for (var i = 0; i < container.length; i++) {
                    ...
                    } else currentTallest = 0, UNCODE.isFrontEndEditor && child !== null && (child.style.height = "", getDivChildren(el, ".owl-carousel", function (owl, i) {
                        owl.style.height = "", isIE && getDivChildren(owl, ".owl-stage", function (owlIn, i) {
                            owlIn.style.height = ""
                        })
                    }));
                    if (wwidth > mediaQuery) {
                        getDivChildren(el, ".column_parent", function (col, i, total) {
                            ...
                            getDivChildren(col, ".row-child", function (obj, i, total) {
                                ...
                                var $colChild = obj,
                                    $colInner, $colParent = $colChild.parentNode,
                    ...
                    } else isFF && getDivChildren(el, ".uncoltable", function (col, i, total) {
                ...
                function toggleOverlay(btn) {
                    Array.prototype.forEach.call(document.querySelectorAll("div.overlay"), function (overlay) {
                        if (btn.getAttribute("data-area") == overlay.getAttribute("data-area")) {
                            ...
                            } else classie.has(overlay, "close") || (window.dispatchEvent(menuOpen), overlayOpened = !0, classie.add(overlay, "open"), classie.add(container, "overlay-open"), jQuery("body.menu-overlay").length == 0 && setTimeout(function () {
                                inputField.focus()
                    ...
                    if (classie.hasClass(triggerButton, "close")) UNCODE.menuOpened = !1, classie.removeClass(triggerButton, "close"), classie.addClass(triggerButton, "closing"), Array.prototype.forEach.call(closeButtons, function (closeButton) {
            ...
            shrinkMenu = function (bodyTop) {
                ...
                for (var i = 0; i < logoel.length; i++)(secmenuHeight == 0 ? bodyTop > menuHeight : bodyTop > secmenuHeight + offset) && !classie.hasClass(logoel[i], "shrinked") && wwidth > mediaQuery ? (classie.addClass(logoel[i], "shrinked"), logoMinScale != undefined && (logoShrink = logolink.children, Array.prototype.forEach.call(logoShrink, function (singleLogo) {
                ...
                if (typeof kenburnsHeaders == "object" && kenburnsHeaders.length)
                    for (var i = 0; i < kenburnsHeaders.length; i++) {
                        ...
                        if (offSetPosition > 0 && offSetPosition < sectionHeight + wheight)
                            for (var i = 0; i < $kenburnsInner.length; i++) classie.addClass($kenburnsInner[i], "uncode-kburns"), $kenburnsInner[i].dispatchEvent(new CustomEvent("enter-kburns"));
                        else
                            for (var i = 0; i < $kenburnsInner.length; i++) classie.removeClass($kenburnsInner[i], "uncode-kburns"), $kenburnsInner[i].dispatchEvent(new CustomEvent("exit-kburns"))
                    }
            },
            kenburnsRowCol = function (bodyTop) {
                var value;
                UNCODE.isFrontEndEditor && (kenburnsRows = document.querySelectorAll(".with-kburns > .row-background > .background-wrapper, .with-kburns > .fp-tableCell > .row-background > .background-wrapper, .with-kburns > .fp-tableCell > .fp-scrollable > .fp-scroller > .row-background > .background-wrapper"));
                ...
                UNCODE.isFrontEndEditor && (kenburnsCols = document.querySelectorAll(".with-kburns > .column-background > .background-wrapper"));
            ...
            backwashHeader = function (bodyTop) {
                ...
                if (typeof backwashHeaders == "object" && backwashHeaders.length)
                    for (var i = 0; i < backwashHeaders.length; i++) {
                        ...
                        if (offSetPosition > 0 && offSetPosition < sectionHeight + wheight)
                            for (var i = 0; i < $backwashInner.length; i++) classie.addClass($backwashInner[i], "uncode-zoomout"), $backwashInner[i].dispatchEvent(new CustomEvent("enter-zoomout"));
                        else
                            for (var i = 0; i < $backwashInner.length; i++) classie.removeClass($backwashInner[i], "uncode-zoomout"), $backwashInner[i].dispatchEvent(new CustomEvent("exit-zoomout"));
            ...
            backwashRowCol = function (bodyTop) {
                ...
                UNCODE.isFrontEndEditor && (backwashRows = document.querySelectorAll(".with-zoomout > .row-background > .background-wrapper, .with-zoomout > .fp-tableCell > .row-background > .background-wrapper, .with-zoomout > .fp-tableCell > .fp-scrollable > .fp-scroller > .row-background > .background-wrapper"));
                ...
                UNCODE.isFrontEndEditor && (backwashCols = document.querySelectorAll(".with-zoomout > .column-background > .background-wrapper"));
            ...
            parallaxRowCol = function (bodyTop) {
                var value;
                UNCODE.isFrontEndEditor && (parallaxRows = document.querySelectorAll(".with-parallax > .row-background > .background-wrapper, .with-parallax > .fp-tableCell > .row-background > .background-wrapper, .with-parallax > .fp-tableCell > .fp-scrollable > .fp-scroller > .row-background > .background-wrapper"));
                ...
                UNCODE.isFrontEndEditor && (parallaxCols = document.querySelectorAll(".with-parallax > .column-background > .background-wrapper"));
                if (typeof parallaxCols == "object")
                    for (var j = 0; j < parallaxCols.length; j++) {
                        var section = parallaxCols[j].parentNode,
                            ...
                            offSetTop = bodyTop + (section != null ? section.getBoundingClientRect().top : 0),
                            offSetPosition = wheight + bodyTop - offSetTop;
                        offSetPosition > 0 && offSetPosition < sectionHeight + wheight && (value = (offSetPosition - wheight) * speedDivider, value *= .8, Math.abs(value) < thisHeight - sectionHeight ? translateElement(parallaxCols[j], Math.floor(value)) : translateElement(parallaxCols[j], Math.floor(thisHeight - sectionHeight)))
                    }
            },
            ...
            hideMenu = function (bodyTop) {
                ...
                if (typeof menuhide == "object" && menuhide != null && mainmenu[0] != undefined) {
                    var translate, scrollingDown = !0,
                        sticky_element = typeof mainmenu.item == "undefined" ? wwidth > mediaQuery ? mainmenu[0] : mainmenu[1] : mainmenu[0];
            ...
            setScrollPosition, scrollFunction = function () {
                if (!UNCODE.isFullPage) {
                    ...
                    clearRequestTimeout(setScrollPosition), setScrollPosition = requestTimeout(function () {
                        scrollRowHeight_fix = window.pageYOffset
                    }, 100)
                }
            },
            shapeDivider = function () {
                ...
                forEachElement($shape, function ($el, i) {
                    var elH = parseInt($el.getAttribute("data-height")),
                        ...
                        newEl, $parent = $el.parentNode,
                        parentH, $svg = $el.getElementsByTagName("svg")[0];
                    if (elHunit == "px") {
                        switch (!0) {
        ...
        !noScroll && document.body == null && window.addEventListener("scroll", function (e) {
            ...
            scrollRowHeight_fix = window.pageYOffset, Array.prototype.forEach.call(document.querySelectorAll(".row-inner"), function (el) {
                el.style.height = "", el.style.marginBottom = ""
            }), setRowHeight(document.querySelectorAll(".page-wrapper .row-parent, footer .row-parent"), !1, !0)
        });
        var setIsScrolling;
        window.addEventListener("scroll", function () {
            UNCODE.setIsScrolling = !0, clearRequestTimeout(setIsScrolling), setIsScrolling = requestTimeout(function () {
                UNCODE.setIsScrolling = !1
            }, 66)
        }), window.addEventListener("resize", function () {
            scrollRowHeight_fix = window.pageYOffset, docheight = boxWrapper != undefined && boxWrapper[0] != undefined ? boxWrapper[0].offsetHeight : 0;
            var oldWidth = wwidth;
            ...
            }, 10), UNCODE.setIsScrolling || (clearTimeout(resizeTimer), resizeTimer = setTimeout(function () {
                UNCODE.setIsScrolling || (UNCODE.wheight = wheight = (window.innerHeight || document.documentElement.clientHeight) - bodyBorder * 2, Array.prototype.forEach.call(document.querySelectorAll(".row-inner"), function (el) {
                    el.style.height = "", el.style.marginBottom = ""
    ...
    function () {
        ...
        Vivus.LINEAR = function (x) {
            ...
            var allowedTypes = ["delayed", "sync", "async", "nsync", "oneByOne", "scenario", "scenario-sync"],
                allowedStarts = ["inViewport", "manual", "autostart"];
            ...
            if (this.forceRender && this.map && this.map[index]) {
                var pathObj = this.map[index],
                    newPath = pathObj.el.cloneNode(!0);
            ...
            if (element && element.attributes)
                for (var i = 0; i < element.attributes.length; i++) attr = element.attributes[i], output[attr.name] = attr.value;
            return output
